...
#define DETECT1_PORT		GPIOF
#define DETECT1_PIN			GPIO_Pin_9
#define DETECT2_PORT		GPIOF
#define DETECT2_PIN			GPIO_Pin_10
...
/* MAGNETIC_DET PF.10, in, low */ \
#define TGT_MAGNETIC_DET2   BSP_DEV_obj(GPIOH, PIN6)
/* LIGHT_FWD PF.11, out, high */
...
#define DETECT1_PORT		GPIOH
#define DETECT1_PIN			GPIO_Pin_9
#define DETECT2_PORT		GPIOH
#define DETECT2_PIN			GPIO_Pin_6
